...
function generateEditMenuMobile(index, circleColor, contactInitials) {  
  return`
  <div id="edit_contacts" class="edit-contacts">
  <div id="edit_icon" class="edit-icon">
    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
  ...
  <div id="edit_contact_mobile" class="edit-text" onclick="editContacts(${index})">Edit</div>
</div>
<div id="delete_container_mobile" class="delete-container" onclick="deleteContact(${index})">
  <div id="delete_icon" class="delete-icon">
    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
      <mask id="mask0_71348_10272" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="25" height="24">
        <rect x="0.5" width="24" height="24" fill="#D9D9D9"/>
